...
# For ffa-w3-211 airfoil at Re=0.75M
set initds 0.00003073
...
set fname "D:/PhotonUser/My Files/Home Folder/S809_interpolate.dat"
pw::Database import $fname
    set imported 2
...
unset _TMP(PW_11)
unset _TMP(PW_13)
pw::Application save "C:/Temp/S809_Re=0.75M_AoA0_nSpan=50.pw"
...
set _TMP(mode_1) [pw::Application begin CaeExport [pw::Entity sort [list $_BL(1)]]]
  $_TMP(mode_1) initialize -strict -type CAE "C:/Temp/S809_Re=0.75M_AoA0_nSpan=50.exo"
  $_TMP(mode_1) verify
  $_TMP(mode_1) write
$_TMP(mode_1) end
unset _TMP(mode_1)
