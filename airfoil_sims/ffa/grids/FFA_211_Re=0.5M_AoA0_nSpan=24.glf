...
# For ffa-w3-211 airfoil at Re=0.5M
set initds 0.00004478
set cellgr_near 1.04
set cellgr_away 1.09
set bldist 0.4
set numpts 335
set lfac 62.08128629
set tfac 62.08128629
set nupperfac 0.5
set nspan 24
set aoa 0 
...
unset _TMP(PW_11)
unset _TMP(PW_13)
pw::Application save "C:/Temp/FFA_211_Re=0.5M_AoA0_nSpan=24_params_set.pw"
#pw::Application save /scratch/sbidadi/FIVM_ffa_w3/af_polar_exawind/nalu_inputs/grids/flat_plate/FFA_211_Re=0.5M_AoA0_nSpan=24.pw
set _TMP(mode_1) [pw::Application begin CaeExport [pw::Entity sort [list $_BL(1)]]]
  $_TMP(mode_1) initialize -strict -type CAE "C:/Temp/FFA_211_Re=0.5M_AoA0_nSpan=24_params_set.exo"
  $_TMP(mode_1) verify
  $_TMP(mode_1) write
$_TMP(mode_1) end
unset _TMP(mode_1)
