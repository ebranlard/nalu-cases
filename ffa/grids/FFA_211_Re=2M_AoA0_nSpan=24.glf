...
# For ffa-w3-211 airfoil at Re=2M
set initds 0.00001236
set cellgr_near 1.04
set cellgr_away 1.09
set bldist 0.4
set numpts 335
set lfac 224.9190939
set tfac 224.9190939
set nupperfac 0.5
set nspan 24
set aoa 0 
...
set fname "D:/PhotonUser/My Files/Home Folder/ffa_w3_211_coords.dat"
pw::Database import $fname
    set imported 2
...
unset _TMP(PW_11)
unset _TMP(PW_13)
pw::Application save "C:/Temp/FFA_211_Re=2M_AoA0_nSpan=24_params_set.pw"
#pw::Application save /scratch/sbidadi/FIVM_ffa_w3/af_polar_exawind/nalu_inputs/grids/flat_plate/FFA_211_Re=2M_AoA0_nSpan=24_params_set.pw
set _TMP(mode_1) [pw::Application begin CaeExport [pw::Entity sort [list $_BL(1)]]]
  $_TMP(mode_1) initialize -strict -type CAE "C:/Temp/FFA_211_Re=2M_AoA0_nSpan=24_params_set.exo"
  $_TMP(mode_1) verify
  $_TMP(mode_1) write
$_TMP(mode_1) end
unset _TMP(mode_1)
