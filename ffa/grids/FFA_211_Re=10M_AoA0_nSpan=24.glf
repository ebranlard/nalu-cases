...
unset _TMP(PW_11)
unset _TMP(PW_13)
pw::Application save "C:/Temp/FFA_211_Re=10M_AoA0_nSpan=24.pw"
#pw::Application save /scratch/sbidadi/FIVM_ffa_w3/af_polar_exawind/nalu_inputs/grids/flat_plate/FFA_211_Re=10M_AoA0_nSpan=24.pw
set _TMP(mode_1) [pw::Application begin CaeExport [pw::Entity sort [list $_BL(1)]]]
  $_TMP(mode_1) initialize -strict -type CAE "C:/Temp/FFA_211_Re=10M_AoA0_nSpan=24.exo"
  $_TMP(mode_1) verify
  $_TMP(mode_1) write
$_TMP(mode_1) end
unset _TMP(mode_1)
